...
export const Config = z.object({
  adapter: z.union([z.const('webhook'), z.const('wecom'), z.const('wechatferry'), z.const('relay')]).default('webhook'),
  ...
  /** 中继（小程序远控本机 harness）：adapter 选 relay 时必填 serverUrl/deviceId/token */
  relay: z.object({
    serverUrl: z.string(),
    deviceId: z.string(),
    token: z.string(),
